...
<%      String idGame = request.getParameter("gameID");
        ...
        try {
            ...
            if (rs.next()) {
                ...
                out.println("<h1>" + rs.getString("title") + "</h1>"
                        ...
                        + "<li><b>Edad m�nima: </b>" + rs.getString("minimumAge") + "</li>"
        ...
        try {
            if (rs.next()) {
                ...
                out.println("<li><b>G�nero: </b>" + genres.substring(0, genres.lastIndexOf(",")) + "</li>");
            } else {
                out.println("<li><b>G�nero: </b>" + "Desconocido" + "<li>");
            }
        } catch (SQLException exc) {
            exc.printStackTrace();
        }
        ...
        if (rs.next()) {
            ...
            media = media / n;
            out.println("<li><b>Valoraci�n: </b>" + format.format(media) + "</li>");
        }else{
            out.println("<li><b>Valoraci�n: </b>" + "-" + "</li>");
        }
